...
img = cv2.imread(r'C:\Users\70555119173\Documents\GitHub\curso-visao-computacional\deteccao-de-faces\img\foto-inf3.jpeg')
...
img2 = cv2.resize(img, (1280, 960))  # redimensiona a imagem para 900x600 px e armazena a nova img na variavel img2. 
...
deteccoes = detector_facial.detectMultiScale(img2_cinza, scaleFactor=1.128)  
